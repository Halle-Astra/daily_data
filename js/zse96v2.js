...
!function (e){
    ...
    1514: function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        var D = function(tt) {
            encrypt_core = function (v){
                return __g._encrypt(encodeURIComponent(v))
            }
    ...
    61763: function (tt, te, tr) {
        ...
        function ed(tt, te, tr, ti) {
            var ta = tr.zse93
              ...
              , td = t6(te)
              , tp = [ta, tf, tu, t8(td) && td, tc].filter(Boolean).join("+");
            enc_root_comment = function(tp) {
                return (0, tJ(ti).encrypt)(ty()(tp));
            };
            return {
                source: tp,
                signature: (0,
...
function zse96(url, cookie){
    window.location.href = url;
    return loash.ZP(cookie);
}
// console.log(loash.ZP('sdlkfjsdlkjfsdf'))
console.log(loash.ZP('AKCWoCX1aRaPTtF701AKJHpXNpYb5j__8iQ=|1677847816'))

// console.log(enc_root_comment('c63237f3da159af1029f38ec0b9d78af'))
console.log(window.buffer)


let s_u = '101_3_3.0+/api/v4/comment_v5/answers/3394865374/root_comment?order_by=score&limit=20&offset=+AKCWoCX1aRaPTtF701AKJHpXNpYb5j__8iQ=|1677847816'
mv = '5e03b2f9eb194f08f4c47539bad93e6f'
Math.random = function(){
    return 0.5903276839120801;
}
res = encrypt_core(mv)
console.log('origin md5\t'+mv)
for (i=0;i<2;i++){
    mv = encrypt_core(mv);
    console.log(i+"\t"+mv);
}