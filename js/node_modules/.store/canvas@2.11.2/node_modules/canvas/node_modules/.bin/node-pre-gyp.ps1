...
$new_node_path="$basedir\D:\programs\daily_data\js\node_modules\.store\@mapbox+node-pre-gyp@1.0.11\node_modules\@mapbox"
if ($PSVersionTable.PSVersion -lt "6.0" -or $IsWindows) {
  ...
  $new_node_path="$basedir/D:/programs/daily_data/js/node_modules/.store/@mapbox+node-pre-gyp@1.0.11/node_modules/@mapbox"
}
